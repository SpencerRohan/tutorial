<?php
  // in practice all this php would be in a controller
  // and pulling values from the database and setting page variables
  $companyName = "ACME";
  ...
  /**
   * Extract array items as variables
   */
  extract($data[$code]);
...
<body class="layout-<?= $layout ?>">
  ...
  <div class="container spotlight -background">
    ...
    <div class ="row spotlight__row">
      ...
      <?php $couponClass = ($layout == 'centered') ? 'col-xs-12 --centered' : 'col-md-4 col-md-pull-7'; ?>
      ...
      <div class="<?= $couponClass ?>">
        ...
        <?php include 'partials/coupon.php' ?>
      </div>
    </div>
  </div>
